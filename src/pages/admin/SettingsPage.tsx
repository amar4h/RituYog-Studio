...
import { settingsService, authService, backupService, membershipPlanService, invoiceService, paymentService, memberService, subscriptionService, isApiMode } from '../../services';
import { formatDate, getDayNameShort } from '../../utils/dateUtils';
import { formatCurrency } from '../../utils/formatUtils';
import type { Holiday, InvoiceTemplate, WhatsAppTemplates, MembershipPlan, Invoice } from '../../types';
...
// Tab definitions
type SettingsTab = 'studio' | 'memberships' | 'invoices' | 'whatsapp' | 'holidays' | 'legal' | 'security' | 'data-tools';
...
export function SettingsPage() {
  ...
  // Load invoices when Data Tools tab is active
  useEffect(() => {
    if (activeTab === 'data-tools') {
      if (isApiMode()) {
